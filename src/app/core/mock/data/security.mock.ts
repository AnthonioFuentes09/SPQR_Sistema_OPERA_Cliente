...
export const MOCK_USERS: UserDTO[] = [
  { user_Id: 1, user_Code: 'U001', user_Name: 'Antonio Fuentes',   user_Email: 'afuentes@imhon.com',   company_Code: 'IMHON', is_Active: true,  is_Deleted: false },
  { user_Id: 2, user_Code: 'U002', user_Name: 'María López',       user_Email: 'mlopez@imhon.com',     company_Code: 'IMHON', is_Active: true,  is_Deleted: false },
  { user_Id: 3, user_Code: 'U003', user_Name: 'Carlos Hernández',  user_Email: 'chernandez@imhon.com', company_Code: 'IMHON', is_Active: true,  is_Deleted: false },
  { user_Id: 4, user_Code: 'U004', user_Name: 'Sofía Martínez',    user_Email: 'smartinez@imhon.com',  company_Code: 'IMHON', is_Active: false, is_Deleted: false },
  { user_Id: 5, user_Code: 'U005', user_Name: 'Javier Rodríguez',  user_Email: 'jrodriguez@imhon.com', company_Code: 'IMHON', is_Active: true,  is_Deleted: false },
];
