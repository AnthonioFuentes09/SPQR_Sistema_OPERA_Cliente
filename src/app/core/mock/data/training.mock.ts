...
export const MOCK_TRACKING: CurveTrackDto[] = [
  {
    codeId: 1009, assignment_CodeId: 101,
    employee_Code: 'E004', employee_AltCode: 'A004', employee_Name: 'Luis Galeano',
    curve_Code: 'C_ENSAMBLE_001', curve_Name: 'Curva Básica Ensamble',
    area_AlphaNumId: 'ENSAMBLE 4',
    trainer_Code: 'I001', trainer_Name: 'Roberto Castillo',
    assignment_Week: 25, curve_Level: 9,
    assignment_Progress: 'en-progreso', isCurrentWeek: true,
    base_Hours: 48, target_Efficiency: 60, base_Pieces: 380,
    value_Hours: 0, real_Efficiency: 0, real_Pieces: 0,
    instructorComments: 'Continúa mejorando.',
    editableRow: false, editableHour: false, editableEfficiency: false, editablePieces: false,
  },
  {
    codeId: 2009, assignment_CodeId: 202,
    employee_Code: 'E005', employee_AltCode: 'A005', employee_Name: 'Wendy Gonzales',
    curve_Code: 'C_ENSAMBLE_002', curve_Name: 'Curva Avanzada Ensamble',
    area_AlphaNumId: 'DELANTEROS 1',
    trainer_Code: 'I002', trainer_Name: 'Elena Morales',
    assignment_Week: 25, curve_Level: 3,
    assignment_Progress: 'en-progreso', isCurrentWeek: true,
    base_Hours: 44, target_Efficiency: 62, base_Pieces: 260,
    value_Hours: 0, real_Efficiency: 0, real_Pieces: 0,
    instructorComments: '',
    editableRow: false, editableHour: false, editableEfficiency: false, editablePieces: false,
  },
  {
    codeId: 3004, assignment_CodeId: 301,
    employee_Code: 'E007', employee_AltCode: 'A007', employee_Name: 'Denis Cruz',
    curve_Code: 'C_ENSAMBLE_001', curve_Name: 'Curva Básica Ensamble',
    area_AlphaNumId: 'ENSAMBLE 1',
    trainer_Code: 'I001', trainer_Name: 'Roberto Castillo',
    assignment_Week: 25, curve_Level: 4,
    assignment_Progress: 'en-progreso', isCurrentWeek: true,
    base_Hours: 44, target_Efficiency: 35, base_Pieces: 160,
    value_Hours: 0, real_Efficiency: 0, real_Pieces: 0,
    instructorComments: '',
    editableRow: false, editableHour: false, editableEfficiency: false, editablePieces: false,
  },
